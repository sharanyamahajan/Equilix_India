...
- If no face is detected in the image, set the emotion to 'Unknown', confidence to 0, and provide feedback asking the user to make sure their face is centered and well-lit.
